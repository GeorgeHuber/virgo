...
class DimensionSliceWidget(tk.Frame):
    def __init__(self, parent, node, app, **kwargs):
        ...
        self.dimSelect.grid()
        self.dimValueSelect = ttk.Combobox(self, values=[], textvariable=self.dimValue)
...
class DimensionSlice(base_nodes.FunctionalNode):
    ...
    def render(self):
        self.draggableWidget = graph.DraggableWidget(self, app=self.app, widget=DimensionSliceWidget)